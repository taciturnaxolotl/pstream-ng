        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          <LegalCard
            ...
            description={
              <>
                <Paragraph>
                  pstream-ng functions as a search engine and content aggregator
                ...
                <Link to="/about">Learn more about how pstream-ng works</Link>
              </>
            }
          />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                pstream-ng is entirely self hostable, and can be run on any
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                pstream-ng is licensed under the MIT license.
                <br />
                <br />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                pstream-ng operates within legal boundaries and cooperates with
