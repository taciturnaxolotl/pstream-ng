...
1. [Set up the Proxy!](../proxy/introduction.mdx)
2. [Set up the Client!](../client/introduction.mdx)
...
1. [Set up the Backend!](../backend/introduction.mdx)
2. [Configure the Client!](../client/introduction.mdx)
...
1. [Set up the Proxy!](../proxy/introduction.mdx)
2. [Set up the Backend!](../backend/introduction.mdx)
3. [Set up the Client!](../client/introduction.mdx)
